  ...
  const teachers = [
    {
      ...
      image: "/beleneva-cinema-landing/images/dmitry-tishchenko.jpg",
    },
    {
      ...
      image: "/beleneva-cinema-landing/images/mikhail-ostashkov.jpg",
    },
    {
      ...
      image: "/beleneva-cinema-landing/images/vitaly-karpechenko.jpg",
    },
    {
      name: "Мария Полос",
      ...
      image: "/beleneva-cinema-landing/images/maria-polos.jpg",
    },
    {
      ...
      image: "/beleneva-cinema-landing/images/irina-beleneva.jpg",
    },
  ]
  ...
  const testimonials = [
    {
      ...
      author: "Ксения",
      image: "/beleneva-cinema-landing/images/testimonial-1.png",
    },
    {
      ...
      author: "Екатерина",
      image: "/beleneva-cinema-landing/images/testimonial-2.png",
    },
    {
      text: "У меня каждый раз мозг просто взрывается! 🔥 Спасибо за такие супер-полезные тренинги!!!!",
      author: "Ксения",
      image: "/beleneva-cinema-landing/images/testimonial-3.png",
    },
    {
      ...
      author: "Leon",
      image: "/beleneva-cinema-landing/images/testimonial-4.png",
    },
    {
      ...
      author: "Сергей",
      image: "/beleneva-cinema-landing/images/testimonial-5.png",
    },
    {
      ...
      author: "Максим",
      image: "/beleneva-cinema-landing/images/testimonial-6.png",
    },
  ]
            ...
            {teachers.map((teacher, index) => (
              <Card key={index} className="bg-gray-900 border-gray-800 text-white overflow-hidden">
                <div className="aspect-square relative">
                  <Image src={teacher.image || "/beleneva-cinema-landing/placeholder.svg"} alt={teacher.name} fill className="object-cover" />
                </div>
                <CardHeader>
            ...
            <div className="relative overflow-hidden rounded-lg">
              <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide justify-start md:justify-center">
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image
                    src="/beleneva-cinema-landing/images/student-performance-1.jpg"
                ...
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/classroom-1.jpg" alt="Занятие в классе" fill className="object-cover" />
                </div>
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/classroom-4.jpg" alt="Групповые упражнения" fill className="object-cover" />
                </div>
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/classroom-5.jpg" alt="Работа в парах" fill className="object-cover" />
                </div>
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/student-portrait.jpg" alt="Студент курса" fill className="object-cover" />
                </div>
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/group-photo.jpg" alt="Групповое фото студентов" fill className="object-cover" />
                </div>
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image
                    src="/beleneva-cinema-landing/images/student-performance-2.jpg"
                ...
                <div className="flex-shrink-0 w-72 sm:w-80 lg:w-96 h-48 sm:h-60 lg:h-72 relative rounded-lg overflow-hidden">
                  <Image src="/beleneva-cinema-landing/images/classroom-2.jpg" alt="Лекция в аудитории" fill className="object-cover" />
                </div>
              </div>
            </div>
